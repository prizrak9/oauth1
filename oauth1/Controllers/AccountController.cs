...
namespace oauth1.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task Logout()
        {
            ...
            string logoutUri = $"http://{_configuration["Auth0:Domain"]}/auth/realms/master/protocol/openid-connect/logout?client_id={_configuration["Auth0:ClientId"]}&returnTo={Uri.EscapeDataString(postLogoutUri)}";
